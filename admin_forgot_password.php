...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($result) > 0) {
        ...
        $update_query = "UPDATE admin SET password='$hashed_password' WHERE email='$email'";
...
<body>
    <!-- Employer Forgot Password form -->
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="form-container">
                    <h3 class="text-center">Employer Forgot Password</h3>
                    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                        <div class="form-group">
                            <label for="email">Company Email:</label>
                            <input type="email" class="form-control" id="email" name="email" required placeholder="Enter your company email">
                        </div>
                        <div class="form-group">
